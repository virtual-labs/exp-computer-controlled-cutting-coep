function cut_square(){
	...
	squareHeight = WCJson.SquareY ;
      ...
      balk1.animate({path: "M"+square_X+" "+square_Y+" l "+squareWidth+" "+ 0}, 3000, function() {
             balk1 .animate({path: "M"+square_X+" "+square_Y+" l "+squareWidth+" "+ 0 +"  l "+ 0 +" "+ squareHeight}, 3000, function(){
             balk1 .animate({path: "M"+square_X+" "+square_Y+" l "+squareWidth+" "+ 0 +"  l "+ 0 +" "+ squareHeight+" l "+(-(squareWidth))+" "+ 0}, 3000, function(){
                balk1.animate({path: "M"+square_X+" "+square_Y+" l "+squareWidth+" "+ 0 +"  l "+ 0 +" "+ squareHeight +" l "+(-(squareWidth))+" "+ 0+" z"}, 3000, function(){
     ...
     }).insertBefore(window.setInterval("method_animasi_square()", 30));
...
var counter = 0;
var position;
function method_animasi_square() {
